...
public final class DlgPeresepanDokterNew extends javax.swing.JDialog {
    ...
    public DlgPeresepanDokterNew(java.awt.Frame parent, boolean modal) {
        ...
        HUtil.consume(tbObatResepRacikan.getColumnModel().getColumns(), columns -> {
            columns.nextElement().setPreferredWidth(25);
            columns.nextElement().setPreferredWidth(250);
            HUtil.consume(columns.nextElement(), column -> {
                column.setMinWidth(0);
                column.setMaxWidth(0);
            });
        ...
        HUtil.consume(tbDetailResepObatRacikan.getColumnModel().getColumns(), columns -> {
            columns.nextElement().setPreferredWidth(25);
            columns.nextElement().setPreferredWidth(75);
            columns.nextElement().setPreferredWidth(240);
            columns.nextElement().setPreferredWidth(45);
    ...
    private void initComponents() {
        ...
        Scroll1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Scroll1KeyPressed(evt);
            }
        });
    ...
    private void BtnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCariActionPerformed
        ...
        final int selectedRow = tbObatResepRacikan.getSelectedRow();

        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(null, "Silahkan pilih racikan..!!");
            return;
        }
        if (tbObatResepRacikan.getValueAt(selectedRow, 0).toString().isBlank()
                || tbObatResepRacikan.getValueAt(selectedRow, 1).toString().isBlank()
                || tbObatResepRacikan.getValueAt(selectedRow, 2).toString().isBlank()
                || tbObatResepRacikan.getValueAt(selectedRow, 3).toString().isBlank()
                || tbObatResepRacikan.getValueAt(selectedRow, 4).toString().isBlank()
                || tbObatResepRacikan.getValueAt(selectedRow, 5).toString().isBlank()
                || tbObatResepRacikan.getValueAt(selectedRow, 6).toString().isBlank()) {
    ...
    private void tbResepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbResepKeyPressed
        ...
        final int selectedColumn = tbResep.getSelectedColumn();
        ...
        switch (evt.getKeyCode()) {
            ...
            case KeyEvent.VK_ENTER:
                ...
                if ((selectedColumn == 8) || (selectedColumn == 9)) {
                    hitungResep();
                    TCari.requestFocus();
                }
                break;
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    ...
    final String message = "Eeiiiiiits, udah bener belum data yang mau disimpan..??";

    if (JOptionPane.showConfirmDialog(rootPane, message, "Konfirmasi", JOptionPane.YES_NO_CANCEL_OPTION) != JOptionPane.YES_OPTION) {
        return;
    }
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    private void tbObatResepRacikanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbObatResepRacikanKeyPressed
        ...
        final int selectedColumn = tbObatResepRacikan.getSelectedColumn();
        final int keyCode = evt.getKeyCode();

        if (keyCode == KeyEvent.VK_RIGHT && selectedColumn == 5) {
            akses.setform("DlgCariObat");
        ...
        if (keyCode == KeyEvent.VK_RIGHT && selectedColumn == 3) {
        ...
        if (keyCode == KeyEvent.VK_SHIFT && selectedColumn == 6) {
            TCari.requestFocus();
            return;
        }

        if (keyCode == KeyEvent.VK_ENTER && i == 6) {
            tampildetailracikanresep();
        }
    ...
    private void tbDetailResepObatRacikanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDetailResepObatRacikanKeyPressed
        ...
        final int keyCode = evt.getKeyCode();
        if (!((keyCode == KeyEvent.VK_ENTER) || (keyCode == KeyEvent.VK_RIGHT) || (keyCode == KeyEvent.VK_UP) || (keyCode == KeyEvent.VK_DOWN))) {
            return;
        }

        final int selectedColumn = tbDetailResepObatRacikan.getSelectedColumn();
        final int selectedRow = tbDetailResepObatRacikan.getSelectedRow();
            ...
            if (kenaikan > 0) {
                if (aktifkanbatch.equals("yes")) {
                    ...
                    psresepasuransi = koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"
                            ...
                            + " (databarang.kode_brng like ? or databarang.nama_brng like ? or jenis.nama like ? or databarang.letak_barang like ?) group by gudangbarang.kode_brng order by databarang.nama_brng");
                } else {
                    qrystokkosong = "";
                    if (STOKKOSONGRESEP.equals("no")) {
                        qrystokkosong = " and gudangbarang.stok>0 ";
                    ...
                    psresepasuransi = koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"
                            ...
                            + " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "
                            + " where databarang.status='1' " + qrystokkosong + " and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and "
                            + " (databarang.kode_brng like ? or databarang.nama_brng like ? or jenis.nama like ? or databarang.letak_barang like ?) order by databarang.nama_brng");
                }
