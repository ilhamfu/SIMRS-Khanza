...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        mnKartuWa = new javax.swing.JMenuItem();
        ...
        dlgKirimWa = new javax.swing.JDialog();
        internalFrame7 = new widget.InternalFrame();
        panelBiasa1 = new widget.PanelBiasa();
        label1 = new widget.Label();
        tbNoTelp = new widget.TextBox();
        panelBiasa3 = new widget.PanelBiasa();
        btnKirimWa = new widget.Button();
        btnBatalKirim = new widget.Button();
        ...
        KartuPasien.add(jSeparator1);

        mnKartuWa.setBackground(new java.awt.Color(255, 255, 254));
        mnKartuWa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        mnKartuWa.setForeground(new java.awt.Color(50, 50, 50));
        mnKartuWa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        mnKartuWa.setText("Kartu Pasien 6");
        mnKartuWa.setName("mnKartuWa"); // NOI18N
        mnKartuWa.setPreferredSize(new java.awt.Dimension(150, 26));
        mnKartuWa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnKartuWaActionPerformed(evt);
            }
        });
        KartuPasien.add(mnKartuWa);
        ...
        dlgKirimWa.setName("dlgKirimWa"); // NOI18N

        internalFrame7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "::[ Kirim Kartu Rawat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        panelBiasa1Layout.columnWidths = null;
        ...
        tbNoTelp.setName("tbNoTelp"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.weightx = 1.0;
        panelBiasa1.add(tbNoTelp, gridBagConstraints);

        internalFrame7.add(panelBiasa1, java.awt.BorderLayout.CENTER);

        panelBiasa3.setName("panelBiasa3"); // NOI18N

        btnKirimWa.setForeground(new java.awt.Color(0, 0, 0));
        btnKirimWa.setText("Kirim Ke Whatsapp");
        ...
        panelBiasa3.add(btnKirimWa);

        btnBatalKirim.setText("Batal");
        btnBatalKirim.setName("btnBatalKirim"); // NOI18N
        btnBatalKirim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBatalKirimActionPerformed(evt);
            }
        });
        panelBiasa3.add(btnBatalKirim);

        internalFrame7.add(panelBiasa3, java.awt.BorderLayout.PAGE_END);

        dlgKirimWa.getContentPane().add(internalFrame7, java.awt.BorderLayout.CENTER);
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2023" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-08-2023" }));
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void mnKartuWaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnKartuWaActionPerformed
        dlgKirimWa.setVisible(true);
    }//GEN-LAST:event_mnKartuWaActionPerformed

    private void btnBatalKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBatalKirimActionPerformed
        dlgKirimWa.setVisible(false);
    }//GEN-LAST:event_btnBatalKirimActionPerformed

    private void btnKirimWaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKirimWaActionPerformed
        String no_telp = tbNoTelp.getText().trim();

        if (no_telp.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan isi no wa terlebih dahulu...!!!");
        }
        ...
        param.put("emailrs", akses.getemailrs());
        try {
            ps = koneksi.prepareStatement("UPDATE pasien set no_tlp = ? WHERE no_rkm_medis=?");
            ps.setString(1, no_telp);
            ps.setString(2, TNo.getText());
            ps.executeUpdate();

            final boolean result = Valid.MyReportqryWhatsapp("rptKartuBerobatWA.jasper", "report", tbNoTelp.getText().trim(), "select pasien.no_rkm_medis, pasien.nm_pasien, pasien.no_ktp, pasien.jk, "
                    + "pasien.tmp_lahir, pasien.tgl_lahir, concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab,', ',propinsi.nm_prop) as alamat, pasien.gol_darah, pasien.pekerjaan,"
                    + "pasien.agama,pasien.stts_nikah,pasien.tgl_daftar,pasien.no_tlp,pasien.umur,"
                    + "pasien.pnd, pasien.keluarga, pasien.namakeluarga from pasien inner join kelurahan inner join kecamatan inner join kabupaten "
                    + "inner join propinsi on pasien.kd_prop=propinsi.kd_prop and pasien.kd_kel=kelurahan.kd_kel "
                    + "and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where pasien.no_rkm_medis='" + TNo.getText() + "' ", param);
            ...
            JOptionPane.showMessageDialog(null, "Berhasi mengirim kartu pasien ke nomor pasien");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal mengirim kartu pasien ke nomor pasien");
            System.out.println(e);

        }
        this.setCursor(Cursor.getDefaultCursor());
        dlgKirimWa.setVisible(false);    }//GEN-LAST:event_btnKirimWaActionPerformed
    ...
    private widget.Button btnBatalKirim;
    ...
    private javax.swing.JDialog dlgKirimWa;
    ...
    private javax.swing.JMenuItem mnKartuWa;
    ...
    private widget.TextBox tbNoTelp;
